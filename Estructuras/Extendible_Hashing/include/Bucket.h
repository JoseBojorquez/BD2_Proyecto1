...
void Bucket::load(fstream& file, position_t bucket_position, bucketSize_t bucket_size) {
...
void Bucket::save(fstream &file, position_t bucket_pos, bucketSize_t bucket_size) {
...
void Bucket::save(ofstream &file, bucketSize_t bucket_size) {
    file.write( (char*) &(this->bsize), sizeof(bucketSize_t) );
    file.write( (char*) &(this->next_bucket), sizeof(position_t) );
    // Write all to reserve space
    Record record;
